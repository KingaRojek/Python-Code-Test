...
Use `import_starships` management command to load swapi data.
Ideally this would be loaded in migrations or fixtures.

## Docs

Check out [swagger docs](http://localhost:8008/swagger/).
